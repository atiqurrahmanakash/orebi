...
const Home = () => {
  ...
  useEffect(
    () => {
      let bs = products.filter((b) => (b.best == true));
      let sp = products.filter((s) => (s.special == true))
      // console.log(bs)
      setBestseller(bs)
      setSpecials(sp)
    }, [products]);
    ...
    <>
      ...
      <Container>
        ...
        <div className="bestSeller">
          <h1 className='pb-[48px] font-bold text-[2.44rem] leading-none text-[#262626] font-dm'>Our Bestsellers</h1>
          <div className="itembox mb-[217px]">
            <Slider {...settings2}>
              {
                bestseller?.map((item) => (
